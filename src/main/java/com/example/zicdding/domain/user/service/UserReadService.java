...
public class UserReadService {
    ...
    public UserDto toDto(User user){
        return new UserDto(user.getId(), user.getEmail(), user.getNickname(),user.getPassword(), user.getPhoneNumber() );
    }
    /**
    ...
    public UserDto getUserEmail(String email){
        var user =  userRepository.findByLoginInfoUserId(email).orElseThrow();
        return toDto(user);
    }
}
